...
static const char qt_meta_stringdata_SystemTray[] = {
    "SystemTray\0"
};
...
const QMetaObjectExtraData SystemTray::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SystemTray::staticMetaObject = {
    { &QSystemTrayIcon::staticMetaObject, qt_meta_stringdata_SystemTray,
      qt_meta_data_SystemTray, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SystemTray::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SystemTray))
