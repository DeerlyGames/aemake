...
--
	...
	local shorthelp     = "Type 'aemake --help' for help"
	local versionhelp   = "aemake (Abstraction Build Generator) %s"
...
---
	...
	function m.locateUserScript()
		local folder_name = path.getname(os.getcwd())
		local defaults = { folder_name..".aeproj" }
		for i = 1, #defaults do
